    ...
    public partial class DocumentSignaturesForm : Form
    {
            ...
            : this()
        {
            ...
            if (_document.InteractiveForm == null)
                throw new Exception(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_DOCUMENT_DOES_NOT_CONTAIN_DIGITAL_SIGNATURES);
        ...
        private void verifyAllButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < _signatures.Count; i++)
            {
                ...
                else
                {
                    ...
                    node.Nodes[0].Text = PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_VERIFYING_SIGNATURE;
                    node.Expand();
                        ...
                        if (signerRevision != null && signatureVerifyResult && !signatureCoversWholeDocument)
                        {
                            ...
                            using (PdfDocumentRevisionComparer revisionComparer = signatureInfo.GetDocumentChanges())
                            {
                                ...
                                if (revisionComparer.ChangedPageContents.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_ARG0_PAGES_MODIFIED, revisionComparer.ChangedPageContents.Count);
                                if (revisionComparer.AddedPages.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_ARG0_PAGES_ADDED, revisionComparer.AddedPages.Count);
                                if (revisionComparer.RemovedPages.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_ARG0_PAGES_REMOVED, revisionComparer.RemovedPages.Count);
                                if (revisionComparer.RemovedAnnotations.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_ANNOTATIONSS_ON_ARG0_PAGES_REMOVED, revisionComparer.RemovedAnnotations.Count);
                                if (revisionComparer.RemovedAnnotations.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_REMOVED_ANNOTATIONS_ON_ARG0_PAGES, revisionComparer.RemovedAnnotations.Count);
                                if (revisionComparer.AddedAnnotations.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_ADDED_ANNOTATIONS_ON_ARG0_PAGES, revisionComparer.AddedAnnotations.Count);
                                if (revisionComparer.ChangedAnnotations.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_CHANGED_ANNOTATIONS_ON_ARG0_PAGES, revisionComparer.ChangedAnnotations.Count);
                                if (revisionComparer.MiscellaneousChanges.Count > 0)
                                    subsequentChangesMessage += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_MISCELLANEOUS_CHANGES_ARG0, revisionComparer.MiscellaneousChanges.Count);
                            }
                        }
                    ...
                    catch (Exception validateException)
                    {
                        failed = true;
                        node.BackColor = FAIL_COLOR;
                        node.Nodes[0].Text = string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_ERROR_ARG0, validateException.Message);
                    ...
                    {
                        validateResult = PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_IS_INVALID;
                    ...
                    {
                        validateResult = PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_VALIDITY_IS_UNKNOWN;
                        validateColor = WARNING_COLOR;
                    }
                    // certificate is valid
                    else
                    {
                        validateResult = PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_IS_VALID;
                    ...
                    if (signatureVerifyResult)
                    {
                        ...
                        {
                            // verification passed
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_VERIFICATION_DOCUMENT_HAS_NOT_BEEN_MODIFIED_SINCE_THIS_SIGNATURE_WAS_APPLIED);
                        ...
                        else
                        {
                            ...
                            {
                                // verification falied
                                subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_VERIFICATION_DOCUMENT_HAS_BEEN_MODIFIED_OR_CORRUPTED_SINCE_IT_WAS_SIGNED);
                                subNode.BackColor = FAIL_COLOR;
                                if (subsequentChangesMessage != "")
                                {
                                    subNode = node.Nodes[0].Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SUBSEQUENT_CHANGES_ARG0, subsequentChangesMessage));
                                    subNode.BackColor = FAIL_COLOR;
                                }
                            }
                            else
                            {
                                ...
                                if (subsequentChangesMessage != "")
                                {
                                    subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_VERIFICATION_THE_REVISION_OF_THE_DOCUMENT_THAT_WAS_COVERED_BY_THIS_SIGNATURE_HAS_NOT_BEEN_ALTERED_HOWEVER_THERE_HAVE_BEEN_SUBSEQUENT_CHANGES_TO_THE_DOCUMENT);
                                    subNode.BackColor = WARNING_COLOR;
                                    subNode = node.Nodes[0].Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SUBSEQUENT_CHANGES_ARG0_ALT1, subsequentChangesMessage));
                                    subNode.BackColor = WARNING_COLOR;
                                }
                                else
                                {
                                    subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_VERIFICATION_DOCUMENT_HAS_NOT_BEEN_MODIFIED_SINCE_THIS_SIGNATURE_WAS_APPLIED_ALT1);
                                    subNode.BackColor = SUCCESS_COLOR;
                                }
                            }
                        }
                    ...
                    {
                        // verification falied
                        subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_VERIFICATION_DOCUMENT_HAS_BEEN_MODIFIED_OR_CORRUPTED_SINCE_IT_WAS_SIGNED_ALT1);
                        subNode.BackColor = FAIL_COLOR;
                    }
                    ...
                    if (signature.HasEmbeddedTimeStamp)
                    {
                        ...
                        {
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_VERIFICATION_TIMESTAMP_IS_VALID);
                            subNode.BackColor = SUCCESS_COLOR;
                        }
                        else
                        {
                            // verification falied
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_VERIFICATION_TIMESTAMP_IS_CORRUPTED);
                            subNode.BackColor = FAIL_COLOR;
                        }
                    }
                    ...
                    if (certChain != null)
                    {
                        ...
                        {
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_CERTIFICATE_VERIFICATION_SIGNERS_CERTIFICATE_IS_VALID);
                            subNode.BackColor = SUCCESS_COLOR;
                        }
                        // if certificate verification is NOT successful 
                        else
                        {
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_CERTIFICATE_VERIFICATION_SIGNERS_CERTIFICATE_IS_INVALID);
                            subNode.BackColor = WARNING_COLOR;
                    ...
                    if (hasTimestampCertificate)
                    {
                        ...
                        {
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_CERTIFICATE_VERIFICATION_CERTIFICATE_IS_VALID);
                            subNode.BackColor = SUCCESS_COLOR;
                        }
                        // if certificate verification is NOT successful 
                        else
                        {
                            subNode = node.Nodes[0].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_CERTIFICATE_VERIFICATION_CERTIFICATE_IS_INVALID);
                            subNode.BackColor = WARNING_COLOR;
        ...
        private void saveDocumentRevisionButton_Click(object sender, EventArgs e)
        {
            ...
            saveFile.Filter = PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_PDF_DOCUMENTS_PDFPDF;
            try
            {
        ...
        private void UpdateUI()
        {
            ...
            {
                PdfDocumentRevision revision = (PdfDocumentRevision)signaturesTreeView.SelectedNode.Tag;
                saveDocumentRevisionButton.Text = string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SAVE_DOCUMENT_RESIVION_ARG0_AS, revision.RevisionNumber);
                saveDocumentRevisionButton.Enabled = true;
            }
            else
            {
                saveDocumentRevisionButton.Text = PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SAVE_DOCUMENT_RESIVION_AS;
        ...
        private void BuildSignaturesTreeView()
        {
            ...
            if (_document.InteractiveForm != null)
            {
                ...
                for (int i = 0; i < signatureFields.Length; i++)
                {
                    ...
                    {
                        signatureText += PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_UNSIGNED_SIGNATURE_FIELD;
                    }
                    else
                    {
                        try
                        ...
                        {
                            signatureText += string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_NOT_SUPPORTED_OR_CORRUPTED_SIGNATURE_ARG0, ex.Message);
                        }
                    }
                    ...
                    if (signatureInfo != null)
                    {
                        if (signature != null)
                        {
                            if (signature.IsSigningImplemented)
                                signaturesTreeView.Nodes[i].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_IS_NOT_VERIFIED);
                            else
                                signaturesTreeView.Nodes[i].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNING_IS_NOT_IMPLEMENTED);
                        }

                        // add signature details
                        TreeNode signatureDetailsNode = signaturesTreeView.Nodes[i].Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_DETAILS);
                        ...
                        if (signature != null)
                        {
                            if (signature.IsTimeStamp || signature.HasEmbeddedTimeStamp)
                            {
                                ...
                                {
                                    timestampDetails = signatureDetailsNode.Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_IS_A_DOCUMENT_TIMESTAMP_SIGNATURE);
                                }
                                else if (signature.HasEmbeddedTimeStamp)
                                {
                                    timestampDetails = signatureDetailsNode.Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_INCLUDES_AN_EMBEDED_TIMESTAMP);
                                    if (signature.TimestampCertificate != null)
                                    {
                                        timestampDetails.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_CERTIFICATE_ARG0, ConvertCertificateToString(signature.TimestampCertificate)));
                                        TreeNode timestampCertificateDetails = timestampDetails.Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_CERTIFICATE_DETAILS);
                                        timestampCertificateDetails.Tag = signature.TimestampCertificate;

                                        if (signature.TimestampCertificateChain.Length > 1)
                                        {
                                            AddCerteficateChainToTreeView(signature.TimestampCertificateChain, timestampDetails.Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_CERTIFICATE_CHAIN));
                                        }
                                    }
                                }
                                timestampDetails.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_TIMESTAMP_DATE_ARG0, signature.TimeStampDate));
                                timestampDetails.Expand();
                            }

                            TreeNode certificateDetails = signatureDetailsNode.Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_CERTIFICATE_DETAILS);
                            certificateDetails.Tag = signature.SigningCertificate;
                            signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNATURE_ALGORITHM_ARG0, signature.SignatureAlgorithmName));
                            if (signature.SigningCertificateChain.Length > 1)
                            {
                                AddCerteficateChainToTreeView(signature.SigningCertificateChain, signatureDetailsNode.Nodes.Add(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_CERTIFICATE_CHAIN));
                            }
                        }

                        // add signature information details
                        signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_FILTER_ARG0_ARG1, signatureInfo.Filter, signatureInfo.SubFilter));

                        if (signatureInfo.SignerName != null)
                            signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_NAME_OF_SIGNER_ARG0, signatureInfo.SignerName));
                        if (signatureInfo.Reason != null)
                            signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_REASON_ARG0, signatureInfo.Reason));
                        if (signatureInfo.ContactInfo != null)
                            signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_CONTACT_INFO_ARG0, signatureInfo.ContactInfo));
                        if (signatureInfo.Location != null)
                            signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_LOCATION_ARG0, signatureInfo.Location));
                        if (signatureInfo.SigningTime != DateTime.MinValue)
                            signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_SIGNING_TIME_ARG0, signatureInfo.SigningTime));
                        if (signatureInfo.BuildProperties != null)
                        {
                            if (signatureInfo.BuildProperties.Application != null)
                            {
                                if (signatureInfo.BuildProperties.Application.Name != null)
                                    signatureDetailsNode.Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_APPLICATION_ARG0, signatureInfo.BuildProperties.Application.Name));
                            }
                        }
                    }

                    if (signatureField.Annotation.Page != null)
                        signaturesTreeView.Nodes[i].Nodes.Add(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_SECURITY_PAGE_ARG0, _document.Pages.IndexOf(signatureField.Annotation.Page) + 1));
