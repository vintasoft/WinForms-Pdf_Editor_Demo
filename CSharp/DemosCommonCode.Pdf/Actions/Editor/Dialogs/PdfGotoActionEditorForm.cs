            ...
            switch ((PdfDestinationType)positionComboBox.SelectedItem)
            {
                ...
                case PdfDestinationType.XYZoom:
                    ...
                    if (destinationXCheckBox.Checked)
                    {
                        ...
                        {
                            DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_X_COORDINATE_IS_NOT_A_VALID_FLOAT_NUMBER);
                    ...
                    if (destinationYCheckBox.Checked)
                    {
                        ...
                        {
                            DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_Y_COORDINATE_IS_NOT_A_VALID_FLOAT_NUMBER);
                ...
                case PdfDestinationType.FitRectangle:
                    ...
                    {
                        DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_X_COORDINATE_IS_NOT_A_VALID_FLOAT_NUMBER_ALT1);
                    ...
                    {
                        DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_Y_COORDINATE_IS_NOT_A_VALID_FLOAT_NUMBER_ALT1);
                    ...
                    {
                        DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_WIDTH_IS_NOT_A_VALID_FLOAT_NUMBER);
                    ...
                    {
                        DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_HEIGHT_IS_NOT_A_VALID_FLOAT_NUMBER);
                    ...
                    if (width <= 0)
                    {
                        DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_WIDTH_MUST_BE_POSITIVE);
                        destinationFitRectangleWidthTextBox.SelectAll();
                        destinationFitRectangleWidthTextBox.Focus();
                        return;
                    }
                    ...
                    if (height <= 0)
                    {
                        DemosTools.ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_PDF_HEIGHT_MUST_BE_POSITIVE);
                        destinationFitRectangleHeightTextBox.SelectAll();
                        destinationFitRectangleHeightTextBox.Focus();
                        return;
                    }
