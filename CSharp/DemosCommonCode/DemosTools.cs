    ...
    public class DemosTools
    {
        ...
        public static bool ParseFloat(string text, string fieldName, out float value)
        {
            if (ParseFloat(text, out value))
                return true;
            ShowErrorMessage(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_ARG0_HAS_INVALID_FORMAT, fieldName));
            return false;
        }
        ...
        {
            ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_ERROR, message);
        }
        ...
        {
            ShowErrorMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_ERROR_ALT1, ex);
        }
        ...
        {
            MessageBox.Show(string.Format("{0} ({1})", ex.Message, Path.GetFileName(filename)), PdfEditorDemo.Localization.Strings.COMMONCODE_ERROR_ALT2, MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        {
            ShowWarningMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_WARNING, message);
        }
        ...
        {
            ShowInfoMessage(PdfEditorDemo.Localization.Strings.COMMONCODE_INFORMATION, message);
        }
        ...
        public static string GetFullExceptionMessage(Exception ex)
        {
            ...
            while (innerException != null)
            {
                if (ex.Message != innerException.Message)
                    sb.AppendLine(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_INNER_EXCEPTION_ARG0, innerException.Message));
        ...
        private static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            if (licenseException != null)
            {
                ...
                MessageBox.Show(string.Format("{0}: {1}", licenseException.GetType().Name, licenseException.Message), PdfEditorDemo.Localization.Strings.COMMONCODE_ERROR_ALT3, MessageBoxButtons.OK, MessageBoxIcon.Error);
