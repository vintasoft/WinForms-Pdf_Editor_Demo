...
namespace CommonCode.CustomControls
{
    ...
    public partial class ColorPanelControl : UserControl
    {
        ...
        public ColorPanelControl()
        {
            ...
            CanSetColor = true;
            toolTip1.SetToolTip(colorButton, PdfEditorDemo.Localization.Strings.COMMONCODE_CUSTOMCONTROLS_CLICK_THE_BUTTON_IF_THE_CURRENT_COLOR_MUST_BE_CHANGED);
            toolTip1.SetToolTip(defaultColorButton, PdfEditorDemo.Localization.Strings.COMMONCODE_CUSTOMCONTROLS_CLICK_THE_BUTTON_IF_THE_CURRENT_COLOR_MUST_BE_SET_TO_THE_DEFAULT_COLOR);
        }
        ...
        public bool CanSetColor
        {
            ...
            set
            {
                ...
                if (value)
                {
                    toolTip = PdfEditorDemo.Localization.Strings.COMMONCODE_CUSTOMCONTROLS_DOUBLE_CLICK_ON_THE_PANEL_IF_THE_CURRENT_COLOR_MUST_BE_CHANGED;
                    cursor = Cursors.Hand;
                }
