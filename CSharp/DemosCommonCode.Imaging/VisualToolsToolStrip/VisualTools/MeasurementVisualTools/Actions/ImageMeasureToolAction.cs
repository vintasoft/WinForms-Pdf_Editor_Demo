    ...
    public class ImageMeasureToolAction : VisualToolAction
    {
        ...
        private void AddMeasurementAnnotationActions(List<VisualToolAction> actions)
        {
            ...
            VisualToolAction lineMeasureAction = new VisualToolAction(
                PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_LINE_MEASURE, PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_STARTS_THE_MEASUREMENT_USING_LINE, null, true);
            ...
            VisualToolAction linesMeasureAction = new VisualToolAction(
                PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_LINES_MEASURE, PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_STARTS_THE_MEASUREMENT_USING_LINES, null, true);
            ...
            VisualToolAction ellipseMeasureAction = new VisualToolAction(
                PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_ELLIPSE_MEASURE, PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_STARTS_THE_MEASUREMENT_USING_ELLIPSE, null, true);
            ...
            VisualToolAction angleMeasureAction = new VisualToolAction(
                PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_ANGLE_MEASURE, PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_STARTS_THE_MEASUREMENT_USING_ANGLE, null, true);
        ...
        private void AddPropertiesActions(List<VisualToolAction> actions)
        {
            ...
            actions.Add(new VisualToolAction(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_UNITS_OF_MEASURE,
                    PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_UNITS_OF_MEASURE_ALT1, null, false,
                    unitsOfMeasureSubActions.ToArray()));


            VisualToolAction propertiesAction =
                new VisualToolAction(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_PROPERTIES,
                    PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_SHOW_PROPERTIES_FORM_FOR_IMAGE_MEASURE_TOOL, null, false);
            ...
            VisualToolAction measurementPropertiesAction =
                new VisualToolAction(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_MEASUREMENT_PROPERTIES,
                    PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_SHOW_PROPERTIES_FORM_FOR_FOCUSED_MEASUREMENT_ANNOTATION, null, false);
        ...
        private void propertiesAction_Clicked(object sender, EventArgs e)
        {
            ...
            using (PropertyGridForm dlg = new PropertyGridForm(visualTool, PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_IMAGE_MEASURE_TOOL_SETTINGS))
            {
                dlg.ShowDialog();
            }
        }
        ...
        private void measurementPropertiesAction_Clicked(object sender, EventArgs e)
        {
            ...
            using (PropertyGridForm dlg = new PropertyGridForm(visualTool.FocusedAnnotationView, PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_MEASUREMENT_SETTINGS))
            {
                dlg.ShowDialog();
            }
        }
        ...
        private void AddLoadAndSaveActions(List<VisualToolAction> actions)
        {
            VisualToolAction loadMeasurementsAction =
                new VisualToolAction(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_LOAD_MEASUREMENTS,
                    PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_LOAD_THE_MEASUREMENT_ANNOTATIONS_FROM_A_FILE, null, false);
            ...
            VisualToolAction saveMeasurementsAction =
                new VisualToolAction(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_SAVE_MEASUREMENTS,
                    PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING__SAVE_THE_MEASUREMENT_ANNOTATIONS_TO_A_FILE, null, false);
        ...
        private void loadMeasurementsAction_Clicked(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                openFileDialog.Filter =
                    PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_BINARY_ANNOTATIONSVSABMVSABMXMP_ANNOTATIONSXMPMXMPMALL_FORMATSVSABMXMPMVSABMXMPM;
        ...
        private void saveMeasurementsAction_Clicked(object sender, EventArgs e)
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                ...
                saveFileDialog.Filter = PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_BINARY_ANNOTATIONSVSABMXMP_ANNOTATIONSXMPM;
        ...
        private void AddRefreshActions(List<VisualToolAction> actions)
        {
            VisualToolAction refreshAction =
                new VisualToolAction(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_REFRESH_MEASUREMENTS,
                      PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_REFRESH_ALL_MEASUREMENTS_OF_FOCUSED_IMAGE, null, false);
