...
namespace CommonCode.Imaging.Codecs
{
    ...
    public class CodecsFileFilters
    {
        ...
        static void InitImageDecoderFilter()
        {
            ...
            if (AvailableDecoders.IsDecoderAvailable(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_PPTX))
            {
            ...
            if (AvailableDecoders.IsDecoderAvailable(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_CAD))
            {
