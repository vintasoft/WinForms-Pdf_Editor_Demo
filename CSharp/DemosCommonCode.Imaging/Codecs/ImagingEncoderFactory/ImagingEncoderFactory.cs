...
namespace CommonCode.Imaging.Codecs
{
    ...
    public class ImagingEncoderFactory
    {
        ...
        public bool GetEncoder(string filename, out EncoderBase encoder)
        {
            ...
            if (encoder == null)
                throw new NotSupportedException(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_CAN_NOT_FIND_ENCODER_FOR_ARG0, filename));
        ...
        public bool GetEncoderByName(string name, out EncoderBase encoder)
        {
            ...
            // if encoder is not found
            if (encoder == null)
                throw new NotSupportedException(string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_CAN_NOT_FIND_ENCODER_FOR_ARG0_ALT1, name));
        ...
        {
            string message = string.Format(PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_FILE_ARG0_ALREADY_EXISTS_OVERWRITE_IT, Path.GetFileName(filename));

            if (MessageBox.Show(
                message,
                PdfEditorDemo.Localization.Strings.COMMONCODE_IMAGING_CODECS_CONFIRM_OVERWRITE,
